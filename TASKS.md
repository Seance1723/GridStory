...
- [ ] **M5-009** Make the five library archives publication-ready with required README/license metadata, mandatory inventory validation, and isolated consumer-install checks.

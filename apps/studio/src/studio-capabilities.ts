...
export const studioMethodOperations = {
  ...
  createNavigationMenu: ['content.create'],
  getNavigationMenuDraft: ['content.read'],
  getPublishedNavigationMenu: ['content.read'],
  getTranslationCompleteness: ['content.read'],
  createTranslation: ['content.create'],

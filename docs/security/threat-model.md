...
The repository does not supply a live provider, complete PII/DLP discovery, provider TLS/egress/secret/region/retention/training/billing certification, streaming, tools, agents, conversations, fallback, semantic search, suggestions, evaluation/provenance, human approval, or content writes. Those require deployment evidence or the separately scoped M7-005 control design.

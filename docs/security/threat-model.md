...
| THREAT-0019 | Resource exhaustion and unbounded retention | D | 16 High | M5-004 adds low-cardinality application/Collector metrics, queue-capacity alerts, and explicit telemetry retention targets; benchmark-backed application limits and quotas remain M5-007. |
